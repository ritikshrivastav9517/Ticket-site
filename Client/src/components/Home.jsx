...
const getStationCode = (stationString) => {
    if (!stationString || !stationString.includes('(')) {
...
const HomeTicketItem = ({ ticket, onDelete }) => {
    ...
    const isOwner =
        userInfo && userInfo._id === ticket.postedBy?._id;

    const handleDetailsClick = () => {
        if (ticket.travelType === 'bus') {
            navigate('/bus-tickets', {
                state: { scrollToId: ticket._id }
            });
        } else {
